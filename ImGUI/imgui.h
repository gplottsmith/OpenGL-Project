...
enum ImGuiKey_
{
    ...
    ImGuiKey_COUNT, //Me writing below here idk if this works!
    ImGuiKey_W,
    ImGuiKey_S,
    ImGuiKey_D,
    ImGuiKey_E,
...
struct ImGuiIO
{
    ...
    int         KeyMap[ImGuiKey_COUNT + 5];         // <unset>          // Map of indices into the KeysDown[512] entries array which represent your "native" keyboard state.
